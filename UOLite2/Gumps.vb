...
Namespace SupportClasses
    ...
    Public Class Gump
        ...
        Public ReadOnly Property Text() As String()
            ...
            End Get
        End Property
        Public ReadOnly Property Serial() As UInteger
            Get
                Return _Serial
            End Get
        End Property
        Public ReadOnly Property Data() As String()
            ...
            End Get
        End Property
        Public ReadOnly Property Pages() As HashSet(Of Page)
            Get
                Return _Pages
            End Get
        End Property
        ...
        Friend Sub New(ByRef GumpPacket As Packets.CompressedGump, ByRef Client As LiteClient)
            ...
            _Data = LCase(GumpPacket.DecompressedGumpData).Split(vbNewLine)
            _Text = GumpPacket.DecompressedTextData.Split(vbNewLine)
            Dim CurrentPage As New Page(0, Me)
            Dim tim() As String

            For Each s As String In _Data
                tim = s.Split(" ")
        ...
        Public NotInheritable Class CroppedText
            ...
            Public ReadOnly Property Text As String
                Get
                    Return _Page._Gump._Text(_TextID)
                End Get
            End Property
